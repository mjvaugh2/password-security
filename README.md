...
phpBB2 was the most up to date  version at that time – and it had some security related issues. This lead to my websites I had created for friends to come and keep in touch on, to be hacked. One vulnerability that existed in phpBB2 was that passwords were only hashed with md5 – which was proven ineffective. This got me interested in data security. </p>
